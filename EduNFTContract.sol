...
contract EduNFT is KIP17Full, Ownable {
    ...
    function listedTokens(uint256 tokenId) 
        public
        view
        returns (
            uint256,
    ...
    {
        return (
            idToListedToken[tokenId].tokenId, 
    ...
    function listNFT(string memory tokenURI, uint256 price)
        public
        payable
        returns (uint256)
    {
    ...
    function createListedToken(uint256 tokenId, uint256 price) 
        private
    {
        // Make sure the sender sent enough Klay to pay for listing
