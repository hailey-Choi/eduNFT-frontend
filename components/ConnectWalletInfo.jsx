...
export function ConnectWalletInfo() {
  return (
    <div className="px-6">
      <p>
        Welcome to EduNFT! If you're new to the world of cryptocurrencies, you
        may be wondering what a crypto wallet is and why it's needed to
        participate in our marketplace.
        <br />
        <br /> A crypto wallet is a digital wallet that allows you to store,
        manage, and transact with cryptocurrencies. In EduNFT, you'll need a
        Kaikas wallet to store and manage Klaytn coins called KLAY on testnet,
        which you'll use to buy and sell NFTs. Testnet coin is a digital token
        that mimics the behavior of real Klaytn blockchain coins, but has no
        monetary value. It allows you to test out the features of our
        marketplace and practice buying and selling NFTs without risking any
        real money. When you create a crypto wallet, you'll be given a public
        address and a private key. The public address is what you'll use to
        receive Klay, while the private key is what you'll use to access and
        manage your Klay. It's important to keep your private key secure and
        never share it with anyone, as it provides access to your wallet and all
        the Klay stored within it.
        <br />
        <br />
        In summary, a crypto wallet is essential for participating in EduNFT. It
        allows you to store and manage your Klay, ensuring that your
      ...
      <div>
        <ol className="list-decimal list-inside space-y-3 mt-3">
          <li>
            ...
            , KLAY Faucet menu on the left bar brings you to the testnet KLAY
            request page. The requested page will show your address and the
            current testnet KLAY balance of your account.
          </li>
          <Image
          ...
          />
          <li>
            Clicking Run Faucet button will send you 5 testnet KLAY and your
            balance will be updated. Note that you can run the faucet for each
            account once every 24 hours.
          </li>
        </ol>
        <div className="mt-5 italic text-sm text-gray-400">
          Reference:{" "}
